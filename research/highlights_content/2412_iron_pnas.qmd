...
meta:
  - name: description
    content: "Research highlight from the Machine Learning for Materials Design (ML4MD) Lab: Probing Iron in Earth’s Core with Molecular-Spin Dynamics."
  - name: keywords
    content: "ML4MD Lab, Research, Highlight, Iron, Earth's Core, Molecular-Spin Dynamics, Magnetic Materials"
#author: "Attila Cangi"
...
categories:
  ...
  - Machine Learning
---
![](2412_iron_pnas.webp){.overview-thumbnail alt="Abstract image for Probing Iron in Earth’s Core with Molecular-Spin Dynamics" width="35%"}
